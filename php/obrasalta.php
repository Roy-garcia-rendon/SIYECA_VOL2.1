...
if(isset($_GET["pro"])){
  ...
  $dependencia=$_GET['dependencia'];
    ...
    $query="INSERT INTO  obras_publicas_nomina (nombre,edad,curp,num_tel,nacionalidad,genero,dirreccion,profesion,ocupacion,tipo_de_sangre,rfc,estado_civil,tel_emergencia,dependencia) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
